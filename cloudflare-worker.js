...
<div class="card" id="app">
  ...
  <details style="margin-top:20px;font-size:12px;color:#8b949e">
    <summary style="cursor:pointer;user-select:none">转发设置</summary>
    <div class="input-row" style="margin-top:10px">
      <input id="proxyInput" type="text" placeholder="https://your-worker.workers.dev" />
...
// 调用链：内置公共转发 > 自定义转发 > 同源后端(/api/check) > 浏览器直连
